 ...
 * |                                                                       |
 * | Programa...: Estoque.php                                              |
 * |                                                                       |
 * | Autor......: Ivan <ivan.silva@vilanova.com.br>                        |
 * |                                                                       |
 * | Criação....: 10-12-2019                                               |
 * |                                                                       |
 * | Objetivo...: Formatar registros conforme Layout Pernod Estoque        | 
 * |                                                                       |
...
class Estoque
{
    ...
    public function header_estoque($identificador, $cnpj_fornecedor, $data_do_estoque)
    {
        $layout = new Layout();

        // CAMPO: ORDEM, DESCRIÇÃO, CONTEUDO, TIPO N/A, TAMANHO, OBRIGATORIO, PREENCHIMENTO
        $layout->adiciona(new Campo(1, 'TIPO DO REGISTRO', 'H', ALFA, 1, OBRIGATORIO, PREENCHIMENTO));
        ...
        $layout->adiciona(new Campo(4, 'DATA DO ESTOQUE', $data_do_estoque, ALFA, 8, OBRIGATORIO, PREENCHIMENTO));
