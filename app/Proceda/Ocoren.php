...
class Ocoren
{
    ...
    public function registro_000($remetente, $destinatario, $data, $hora, $intercambio, $tamanho)
    {
        ...
        $layout->adiciona(new Campo(1,'IDENTIFICADOR DO REGISTRO', 000, NUMERICO, 3, OBRIGATORIO));
    ...
    public function registro_541($cnpj_transportadora, $razao_social_transportadora, $tamanho)
    {
        ...
        // CAMPO: ORDEM, DESCRIÇÃO, CONTEUDO, TIPO N/A, TAMANHO, OBRIGATORIO
        $layout->adiciona(new Campo(1,'IDENTIFICADOR DO REGISTRO', 541, NUMERICO, 3, OBRIGATORIO));
        $layout->adiciona(new Campo(2,'CNPJ(CGC) DA TRANSPORTADORA', $cnpj_transportadora, NUMERICO, 14, OBRIGATORIO));
        $layout->adiciona(new Campo(3,'RAZAO SOCIAL DA TRANSPORTADORA', $razao_social_transportadora, ALFA, 50, OBRIGATORIO));
        $layout->adiciona(new Campo(4,'ESPAÇO', ' ', ALFA, 183, OBRIGATORIO)); 
                                 ...
                                 $hora_inicio_descarregamento_destino, $data_termino_descarregamento_destino, $hora_termino_descarregamento_destino, $data_saida_destino_nf, $hora_saida_destido_nf, $cnpj_emissor_nf_devolucao, $serie_nf_devolucao, $numero_nf_devolucao, $tamanho)
    {
        ...
        // CAMPO: ORDEM, DESCRIÇÃO, CONTEUDO, TIPO N/A, TAMANHO, OBRIGATORIO
        $layout->adiciona(new Campo(1,'IDENTIFICADOR DO REGISTRO', 542, NUMERICO, 3, OBRIGATORIO));
        $layout->adiciona(new Campo(2,'CNPJ(CGC) DO EMISSOR DA NOTA FISCAL', $cnpj_emissor_nf, NUMERICO, 14, OBRIGATORIO));
        $layout->adiciona(new Campo(3,'SERIE DA NOTA FISCAL', $serie_nf, ALFA, 3, OBRIGATORIO));
        $layout->adiciona(new Campo(4,'NUMERO DA NOTA FISCAL', $numero_nf, NUMERICO, 9, OBRIGATORIO));
        $layout->adiciona(new Campo(5,'CODIGO DE OCORRENCIA NA ENTREGA', $codigo_ocorrencia_entrega, NUMERICO, 3, OBRIGATORIO));
        $layout->adiciona(new Campo(6,'DATA DA OCORRENCIA', $data_ocorrencia, NUMERICO, 8, OBRIGATORIO));
        $layout->adiciona(new Campo(7,'HORA DA OCORRENCIA', $hora_ocorrencia, NUMERICO, 4, OBRIGATORIO));
        $layout->adiciona(new Campo(8,'CODIGO DE OBSERVACAO DE OCORRENCIA NA ENTRADA', $cod_observacao_ocorrencia_entrada, NUMERICO, 2, OBRIGATORIO));
        $layout->adiciona(new Campo(9,'NUMERO ROMANEIO, ORDEM DE COLETA, RESUMO DE CARGA, ETC(IDENTIFICACAO DE EMBARQUE)', $numero_romaneio_identf_embarque, ALFA, 20, OBRIGATORIO));
        $layout->adiciona(new Campo(10,'NUMERO SAP, SHIPMENT, ETC(IDENTIFICACAO DE CARGA) - #1', $identf_carga1, ALFA, 20, OBRIGATORIO));
        $layout->adiciona(new Campo(11,'NUMERO SAP, SHIPMENT, ETC(IDENTIFICACAO DE CARGA) - #2', $identf_carga2, ALFA, 20, OBRIGATORIO));
        $layout->adiciona(new Campo(12,'NUMERO SAP, SHIPMENT, ETC(IDENTIFICACAO DE CARGA) - #3', $identf_carga3, ALFA, 20, OBRIGATORIO));
        $layout->adiciona(new Campo(13,'FILIAL EMISSORA DO CONHECIMENTO', $filial_emissora_conhecimento, ALFA, 10, OBRIGATORIO));
        $layout->adiciona(new Campo(14,'SERIE DO CONHECIMENTO', $serie_conhecimento, ALFA, 5, OBRIGATORIO));
        $layout->adiciona(new Campo(15,'NUMERO DO CONHECIMENTO', $numero_conhecimento, ALFA, 12, OBRIGATORIO));
        $layout->adiciona(new Campo(16,'INDICACAO DO TIPO DE ENTREGA', $indicacao_tipo_entrega, ALFA, 1, OBRIGATORIO));
        $layout->adiciona(new Campo(17,'CODIGO DA EMPRESA EMISSORA DA NOTA FISCAL', $codigo_empresa_emissora_nf, ALFA, 5, OBRIGATORIO));
        $layout->adiciona(new Campo(18,'CODIGO DA FILIAL DA EMPRESA EMISSORA DA NF', $codigo_filial_empresa_emissora_nf, ALFA, 5, OBRIGATORIO));
        $layout->adiciona(new Campo(19,'DATA DA CHEGADA NO DESTINO DA NF', $data_chegada_nf, NUMERICO, 8, OBRIGATORIO));
        $layout->adiciona(new Campo(20,'HORA DA CHEGADA NO DESTINO DA NF', $hora_chegada_nf, NUMERICO, 4, OBRIGATORIO));
        $layout->adiciona(new Campo(21,'DATA DO INICIO DO DESCARREGAMENTO NO DESTINO', $data_inicio_descarregamento_destino, NUMERICO, 8, OBRIGATORIO));
        $layout->adiciona(new Campo(22,'HORA DO INICIO DO DESCARREGAMENTO NO DESTINO', $hora_inicio_descarregamento_destino, NUMERICO, 4, OBRIGATORIO));
        ...
        $layout->adiciona(new Campo(30,'ESPAÇO', ' ', ALFA, 12, OBRIGATORIO)); 
    ...
    public function registro_544($qntd_volumes_nf, $qntd_volumes_entregues, $cod_item_nf, $descricao_item_nf, $tamanho)
    {
        ...
        // CAMPO: ORDEM, DESCRIÇÃO, CONTEUDO, TIPO N/A, TAMANHO, OBRIGATORIO
        $layout->adiciona(new Campo(6,'IDENTIFICADOR DO REGISTRO', 544, NUMERICO, 3, OBRIGATORIO));
        $layout->adiciona(new Campo(7,'QUANTIDADE DE VOLUMES DA NOTA', $qntd_volumes_nf, NUMERICO, 6.2, OBRIGATORIO));
        $layout->adiciona(new Campo(8,'QUANTIDADE DE VOLUMES ENTREGUES', $qntd_volumes_entregues, NUMERICO, 6.2, OBRIGATORIO));
        $layout->adiciona(new Campo(9,'CODIGO DO ITEM DA NOTA FISCAL', $cod_item_nf, ALFA, 20, OBRIGATORIO));
        $layout->adiciona(new Campo(10,'DESCRICAO DO ITEM DA NOTA FISCAL', $descricao_item_nf, ALFA, 50, OBRIGATORIO));
        $layout->adiciona(new Campo(11,'ESPAÇO', ' ', ALFA, 161, OBRIGATORIO)); 
    ...
    public function registro_545($cnpj_empresa_frete, $cnpj_empresa_emissora_ocorrencia, $filial_emissor_ocorrencia, $serie_conhecimento_ocorrencia, $numero_conhecimento_ocorrencia , $tamanho)
    {
        ...
        $layout->adiciona(new Campo(5,'SERIE DO CONHECIMENTO ORIGINADOR DA OCORRENCIA', $serie_conhecimento_ocorrencia, ALFA, 5, OBRIGATORIO));
        $layout->adiciona(new Campo(6,'NUMERO DO CONHECIMENTO ORIGINADOR DA OCORRENCIA', $numero_conhecimento_ocorrencia, ALFA, 12, OBRIGATORIO));
        $layout->adiciona(new Campo(7,'ESPAÇO', ' ', ALFA, 192, OBRIGATORIO)); 
    ...
    public function registro_549($documento, $tamanho)
    {
        ...
        // CAMPO: ORDEM, DESCRIÇÃO, CONTEUDO, TIPO N/A, TAMANHO, OBRIGATORIO
        $layout->adiciona(new Campo(1,'IDENTIFICADOR DO REGISTRO', 549, NUMERICO, 3, OBRIGATORIO));
        $layout->adiciona(new Campo(2,'NUMERO DE REGISTRO DE OCORRENCIA', $numero_ocorrencias, NUMERICO, 4, OBRIGATORIO));
        $layout->adiciona(new Campo(3,'ESPAÇO', ' ', ALFA, 243, OBRIGATORIO)); 
